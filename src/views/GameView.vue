  ...
  &__part {
    ...
    &__character {
      ...
      &__content {
        ...
        justify-content: center;
        background-color: variables.$text;
        box-shadow: inset 0 .4rem 0 0 hsla(229, 25%, 31%, .2);
      }
